...
import { Link2, MapPin, Pencil, Phone, PlayCircle, Twitter, BookA, FileDown } from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-10">
                    <div className="bg-white rounded-lg shadow border p-8 relative">
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="relative cursor-pointer border-2 border-primary rounded-full" onClick={videoResumePreview}>
                                <img
                                    src={
                                        portfolio?.image
                                ...
                                />
                                <div className="flex items-center justify-center absolute bottom-4 right-4 bg-white w-6 h-6 rounded-full border-2 border-white">
                            ...
                            <div className="ml-auto mt-4 md:mt-0 flex flex-col gap-2">
                                <div className='flex items-center space-x-2 absolute top-4 right-8'>
                                    <Button asChild variant="outline" size="icon" className='bg-white' >
                                        <Link to="/portfolio/edit"><Pencil size={20} /></Link>
                                    </Button>
                                    <Button asChild variant="outline" size="icon" className='bg-white' onClick={() => setExportDialog(true)}>
                                        <span><FileDown /></span>
                                    </Button>
                                </div>
