                        ...
                        Array.isArray(queries) ? (
                            queries.map((query, index) => (
                                query.type == '1' && (
                                    <div
                                        key={`inbox-${index}`}
                                        className="flex bg-gray-200 dark:bg-gray-800 rounded-lg justify-between mb-3 items-center p-4  hover:dark:bg-gray-700 hover:bg-gray-300 transition cursor-pointer"
