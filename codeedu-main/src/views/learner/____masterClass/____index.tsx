    ...
    return (
        <div className="rounded-lg flex flex-col gap-4">
            <div className='flex justify-between items-center'>
                <Heading title="Master Class" description="List of master classes available for you" className='mb-0' />
