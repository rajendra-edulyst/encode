...
import { useBlogStore } from '@/store/learner/socialStore'
...
function index() {
    ...
    const { setPosts, posts, error, setError, loading, setLoading } = useBlogStore();
...

                {
                    posts.length !== 0 && filteredBlogs.length <= 0 && (
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Blogs found</h3>
                            <p className="text-gray-600">
                                No, blogs found. Please try again later with different search term.
                            </p>
                        </div>
                    )
                }
