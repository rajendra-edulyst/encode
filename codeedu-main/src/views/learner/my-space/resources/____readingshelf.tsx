...
const Readingself = () => {
    ...
    const Readingself = allResources.filter((item) => item.type === "Reading Shelf");


    const tabs = useMemo(() => {
        const uniqueCategories = Array.from(new Set(Readingself.map((item) => item.sub_type)));
    ...
    return (
        <div className='p-6 md:p-10'>
            ...
            <h1 className='text-cblack'>Reading Shelf</h1>
          
            </div>
            <p className='text-lg mt-3' >
                Curated knowledge to fuel insights and inspiration.
            </p>
