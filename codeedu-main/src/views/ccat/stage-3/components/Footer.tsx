  ...
  return (
    <section className={[styles.footer, className].join(" ")}>
      ...
      <div className={styles.copyrightArea}>
        <div className={`${styles.copyright} relative flex justify-center items-center`}>
          <img className={`${styles.copyrightIcon} absolute left-[-15px]`} alt="" src="/ccat-landing-page/copyright.svg" />
          <h3 className={`${styles.copyrights2025All} text-center`}>
