        ...
        <section className="max-w-[1440px] mx-auto px-4 md:px-8 pt-8">
            ...
            <div className='flex flex-col gap-2'>
                <div className='md:flex justify-between items-center'>
                    <Heading title="Explore Courses" description={`Explore our collection of ${pagination?.total || 0} curated courses `} className='mb-3' />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-7">
                    {filteredCourses.map((course) => (
                        <Link
                            ...
                            to={`/courses/details/${course.name?.toLowerCase().replace(/[^a-z0-9]+/g, '-') || 'course'}-${course.id}`}
