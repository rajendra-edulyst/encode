...
interface AcknowledgementTabProps {
  isCompact?: boolean;
}

export default function AcknowledgementTab({ isCompact = false }: AcknowledgementTabProps) {
  ...
  const [ackOption, setAckOption] = useState<string | null>(null);
  ...
  return (
    <div className={`bg-[#1a1a1a] rounded-[20px] border border-gray-700 ${isCompact ? 'p-6' : 'p-8'}`}>
      {latestSubmission && !showNewForm ? (
        <>
          <h3 className={`font-bold text-white mb-6 ${isCompact ? 'text-lg' : 'text-xl'}`}>Your Submitted Response</h3>
        ...
        <>
          <h3 className={`font-bold text-white mb-6 ${isCompact ? 'text-lg' : 'text-xl'}`}>Respond to enCODE support Notifications</h3>
          <div className={`flex flex-col gap-8`}>
            {/* Options */}
            <div className={`w-full grid gap-4 ${isCompact ? 'grid-cols-2 lg:grid-cols-4' : 'md:grid-cols-4 sm:grid-cols-2'}`}>
              <div
                onClick={() => { if (showNewForm || !hasType2) setAckOption('offer_received') }}
                className={`${isCompact ? 'p-4' : 'p-6'} rounded-[20px] flex flex-col justify-center items-center gap-3 transition-colors text-center border border-gray-700 ${(hasType2 && !showNewForm) ? 'opacity-50 cursor-not-allowed bg-[#323232] text-white' : `cursor-pointer ${ackOption === 'offer_received' ? 'bg-[#8cc63f] text-black' : 'bg-[#323232] text-white hover:bg-[#424242]'}`}`}
              >
                <div className={`${isCompact ? 'w-6 h-6' : 'w-8 h-8'} rounded-full border-2 flex items-center justify-center ${ackOption === 'offer_received' ? 'border-black' : 'border-white'}`}>
                  <svg width={isCompact ? "10" : "14"} height={isCompact ? "8" : "10"} viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <div className={`${isCompact ? 'w-6 h-6' : 'w-8 h-8'} rounded-full border-2 flex items-center justify-center ${ackOption === 'no_dont_want' ? 'border-black' : 'border-[#8cc63f]'}`}>
                  <svg width={isCompact ? "10" : "14"} height={isCompact ? "10" : "14"} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${isCompact ? 'w-6 h-6' : 'w-8 h-8'} ${ackOption === 'no_still_looking' ? 'text-black' : 'text-[#8cc63f]'}`}>
              ...
              <div
                ...
                className={`${isCompact ? 'p-4' : 'p-6'} rounded-[20px] flex flex-col justify-center items-center gap-3 cursor-pointer transition-colors text-center border border-gray-700 ${ackOption === 'need_help' ? 'bg-[#8cc63f] text-black' : 'bg-[#323232] text-white hover:bg-[#424242]'}`}
              >
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${isCompact ? 'w-6 h-6' : 'w-8 h-8'} ${ackOption === 'need_help' ? 'text-black' : 'text-[#8cc63f]'}`}>
            ...
            {/* Dynamic content */}
            {ackOption && (
              <div className={`w-full bg-[#2a2a2a] border border-gray-700 rounded-[20px] ${isCompact ? 'p-6' : 'p-8'}`}>
