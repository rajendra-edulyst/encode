...
import { MatchingJobListApiResponse, JobListApiResponse, GetDomainsApiResponse, GetSkillApiResponse, GetJobRoleApiResponse, MatchingJobCandidateApiResponse, ContryResponse, JobActivityApiResponse, CreateSkillApiRequest, CreateJobRoleApiRequest, MatchingJobCandidate, CompanyList, CompanyListApiResponse } from "@industry/@types/jobs";
...
export async function fetchCompanyList() {
    return ApiService.fetchDataWithAxios<CompanyListApiResponse>({
        url: `${endpointConfig.companyList}`,
        method: 'get',
    }).then(response => response.data);
...
export async function fetchActiveJobRoles() {
    return ApiService.fetchDataWithAxios<{ data: { id: number, job_role: string }[] }>({
        url: '/active-job-roles',
        method: 'get',
    }).then(response => response.data);
}
