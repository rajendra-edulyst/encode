...
const formSchema = z.object({
    ...
    alternateEmail: z.string().optional().transform((val) => val?.trim() || '').refine((val) => val === '' || /\S+@\S+\.\S+/.test(val), {
    ...
    instituteurl: z.string().optional(),
    brochure: z.instanceof(File).refine((file) => file.size > 0, {
...
const Institute = () => {
    ...
    // Memoize selected country object and determine if India is selected
        ...
        <div className="h-[550px]  px-4 rounded-lg  bg-white">
            <form className="flex flex-col gap-4 mt-4" onSubmit={handleSubmit(handleSubmitData)}>
                ...
                <div className='border-b-[1px] border-[#FFDCF0] pb-5'>
                    <p className="text-gray-600 text-lg font-bold mt-2">Institute Details</p>
                    <p className="text-gray-600 text-sm">Tell us about your institute</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8  mt-4">
                        <Controller
                            ...
                            render={({ field }) => (
                                <div>
                                    <Label className="font-semibold text-[#263A43]">Institute Name<span className='text-red-500'>*</span></Label>
                                    <Input
                                        type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8  mt-4">
                        <Controller
                            ...
                            render={({ field }) => (
                                <div>
                                    <Label className="font-semibold text-[#263A43]">Institute URL</Label>
                                    <Input
                                        type="text"
                                        ...
                                        {...field}
                                    />
                                    {errors.instituteurl && <p className="text-red-500 text-sm mt-1">{errors.instituteurl.message}</p>}
                                </div>
                            )}
                        />
                    </div>
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, value } }) => (
                            <div className="flex flex-col gap-2 mt-4">
                                <Label className="font-semibold text-[#263A43]">Brochure</Label>
                                ...
                                <div className="relative border-2 border-dashed border-pink-300 rounded-lg p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-pink-50 transition duration-200">
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">Accepted formats: PDF, JPG and PNG</p>
                                    <p className="text-xs text-gray-500 mt-1">PDF less than 10MB</p>
                                    {value && (
