...
const PurchaseInvoice: React.FC<CourseInvoiceProps> = ({
    data = {},
    courseDetails = {},
    user = {},
    onClose,
    ...
    return (
        <div className="min-h-screen print:bg-white print:p-0">
            <div className="max-w-6xl mx-auto mb-4 print:hidden">
                <div className="bg-[#1D1D1D] rounded-[20px] px-6 py-4 flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-white font-semibold text-[20px]">
                                Learning Receipt {invoiceDetails.invoiceNo}
                            </h1>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <tr className="border-b border-gray-300">
                                    <td className="py-4">
                                        ...
                                        {data.purchase_type && String(data.purchase_type).toLowerCase() !== String(courseDetailsComputed.name).toLowerCase() && (
                                            <p className="text-gray-500 text-xs capitalize">{data.purchase_type}</p>
                                        )}
                                        {data.program_id && String(data.purchase_type).toLowerCase() !== 'package' && (
                                            <p className="text-gray-500 text-xs">Course ID: {data.program_id}</p>
                                        )}
                                    ...
                                    <td className="text-center">₹{financials.sellingPrice.toFixed(2)}</td>
                                    <td className="text-center">{courseDetailsComputed.quantity}</td>
                                    <td className="text-right font-bold">₹{financials.sellingPrice.toFixed(2)}</td>
                                </tr>
                            </tbody>
                        </table>
