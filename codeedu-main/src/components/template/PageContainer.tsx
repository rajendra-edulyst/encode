...
const PageContainer = (props: PageContainerProps) => {
    ...
    const defaultClass =
        'box-border flex min-h-[100vh] min-w-0 w-full max-w-full flex-1 flex-col justify-between'
    const pageContainerDefaultClass =
        'page-container relative box-border flex min-h-0 w-full max-w-full flex-1 flex-col'
