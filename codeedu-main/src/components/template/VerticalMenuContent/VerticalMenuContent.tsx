...
const VerticalMenuContent = (props: VerticalMenuContentProps) => {
  ...
  const [expandedKey, setExpandedKey] = useState<string | null>(null) // <-- controlled
    ...
    useEffect(() => {
        if (activedRoute?.parentKey) {
            ...
            setExpandedKey(activedRoute?.parentKey) // open that one by default
    ...
    // only one open at a time: set to key when expanded, null otherwise
                    ...
                    <Fragment key={nav.key}>
                        ...
                        {nav.type === NAV_ITEM_TYPE_COLLAPSE && (
                            <VerticalCollapsedMenuItem
                                ...
                                userAuthority={userAuthority}
                                t={t as TraslationFn}
                                expanded={expandedKey === nav.key}
                                 onToggle={(expanded: boolean) => handleToggle(nav.key, expanded)}
