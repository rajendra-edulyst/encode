...
const Input = forwardRef<HTMLInputElement | HTMLTextAreaElement, InputProps>((props, ref) => {
    ...
    const inputDefaultClass = 'input bg-white focus:ring-0'
    const inputSizeClass = `input-${inputSize} ${CONTROL_SIZES[inputSize].h}`
    const inputFocusClass = `focus:ring-[#00A8E9] focus-within:ring-[#00A8E9] focus-within:border-[#00A8E9] focus:border-[#00A8E9] border border-gray-200`
